...
- **s390x**: vector-facility SIMD kernel, **natively measured on real IBM z15
  (VXE2)** (2026-07-03, `-count=6`): SIMD encode/decode **~3.7–4.2× stdlib** on
...
>
> _Historical cycle-model estimate (superseded by the measurement above):_

| arch | cpu model | SIMD cyc/iter | SIMD input-B/cyc | scalar input-B/cyc | est. speedup |
|---|---|---:|---:|---:|---:|
| s390x | z14 (est.) | 9.5 (12 B in) | ~1.26 | ~0.43 (3 B / 7.0 cyc) | ~2.9× |
